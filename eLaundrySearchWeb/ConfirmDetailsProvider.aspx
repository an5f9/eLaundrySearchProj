<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="ConfirmDetailsProvider.aspx.cs" Inherits="eLaundrySearchWeb.ConfirmDetailsProvider" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <table id="registrationTable" align="left" style="margin-left:50px;border-spacing:0.8em;">
            <tr>
                <td align="left">
                    <asp:Label ID="lblMessage" runat="server" ForeColor="#009900" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblDoordelivery" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
